    ...
    <div className="text-white my-16 flex justify-center">
      <div className="flex flex-col items-center gap-12">
        <div className="flex items-center gap-8">
          <button onClick={prevProduct} className="w-16 h-16 bg-gray-800 rounded-lg flex justify-center items-center">
          ...
          <button onClick={nextProduct} className="w-16 h-16 bg-gray-800 rounded-lg flex justify-center items-center">
